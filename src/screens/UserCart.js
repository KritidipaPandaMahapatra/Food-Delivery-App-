                        ...
                        <Image source={{uri:item.data.foodimageurl}} style={styles.cartimg}/>
                          <View style={styles.cartcardin}>
                              <View style={styles.c1}>
                                <Text style={styles.text1}>{item.quantity}&nbsp;{item.data.foodname}</Text>
                                <Text style={styles.text2}>&#8377;{item.data.foodprice}/each</Text>
                          </View>
                    {item.Addonquantity>0 &&
                    <View style={styles.c2}>
                         <Text style={styles.text3}>{item.Addonquantity}&nbsp;{item.data.foodAddon}</Text>
                         <Text style={styles.text3}>&#8377;{item.data.foodAddonprice}/each</Text>
                    </View>
                    }
